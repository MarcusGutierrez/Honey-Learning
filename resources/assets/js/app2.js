...
Vue.component('node',{
	...
	<button @click="tentativeattack" class="btn node" v-bind:style="styleobjectPointer" v-bind:class="classobject">
	...
	computed : {
		...
		classobject: function()
		{
			return this.classObject;
                ...
                styleobjectPointer : function()
                {
                        return this.styleObjectPointer;
                },
	...
	data : {
		...
		currentattackset : [], 
		possibleattackset : [0,1,2,3,4], // initially only the public nodes
		public : [0,1,2,3,4],
